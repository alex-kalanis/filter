...
class FilterTest(CommonTestClass):
    ...
    def test_filter_basic(self):
        filter = Filter()
        assert not list(filter.get_entries())
        ...
        assert list(filter.get_entries())
    ...
    def test_filter_removal(self):
        ...
        assert 4 == len(list(filter.get_entries()))

        filter.remove(self._mock_entry_3().get_key())
        assert 2 == len(list(filter.get_entries()))
    ...
    def test_filter_order(self):
        ...
        result = list(filter.get_entries())
    ...
    def test_filter_within_filter(self):
        ...
        result = list(filter1.get_entries())
        ...
        result_sub = list(result[1].get_entries())
